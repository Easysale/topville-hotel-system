...
export default function Home() {
  ...
  const images = [
    ...
    "https://images.unsplash.com/photo-1582719478185-2f2b35b1c7a3?auto=format&fit=crop&w=1200&q=80",
  ];
  ...
  return (
    <main className="bg-white text-gray-800">
      ...
      <section className="relative h-screen bg-cover bg-center flex items-center justify-center text-center text-white"
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1600&q=80')" }}>
        <div className="bg-black/40 absolute inset-0"></div>
        <div className="relative z-10 max-w-3xl px-6">
          <h1 className="text-5xl font-bold mb-4 drop-shadow-lg">Topville Hotel Mombasa</h1>
          <p className="text-lg mb-6">Relax. Refresh. Reconnect — Modern Luxury by the Coast</p>
          <a href="https://wa.me/254781809900"
            target="_blank"
      ...
      <section id="rooms" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-blue-800 mb-8">Our Rooms</h2>
          <p className="text-gray-600 mb-12">Experience comfort and elegance in every detail.</p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {rooms.length > 0 ? (
              rooms.map((room) => (
                <div key={room.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                  <img src={room.image_url} alt={room.alt_text} className="w-full h-60 object-cover" />
                  <div className="p-5 text-left">
                    <h3 className="text-xl font-semibold mb-2 text-blue-800">{room.title}</h3>
      ...
      <section id="gallery" className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
            Discover the beauty of Topville Hotel Mombasa — where every corner tells a story of elegance and tranquility.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">
              We’d love to hear from you. Whether it’s booking inquiries or general questions, reach us anytime.
            </p>
            <form className="space-y-4">
              <input type="text" placeholder="Full Name" className="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-600" />
              <input type="email" placeholder="Email Address" className="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-600" />
              <textarea placeholder="Message" rows="4" className="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-600"></textarea>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              Relax, Refresh, and Reconnect with us at Topville Hotel Mombasa.
            </p>
          </div>
